...
const navigation = [
    { name: 'Dashboard', href: '/Assignment', current: true },
    { name: 'List of Submitted Assignments', href: '#', current: false },
    { name: 'Submit Assignments', href: '#', current: false },
...
function StudentNavbar()
{
    return <React.Fragment>
        <Helmet>                        
    <style>{'body { background: linear-gradient(to top right, #FF3700, #FBF8FF);height: 100vh; }'}</style>
    </Helmet>
    <Disclosure as="nav" className="bg-[#FFE700]">
      {({ open }) => (
        <>
